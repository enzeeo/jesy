...
Current tables from `scripts/snowflake_init.sql`:
...
- Dynamic Tables for live serving views
- H3/geospatial clustering and route coverage
- Snowpark Python UDFs
- Layered schemas: `RAW`, `CLEAN`, `GEO`, `FEATURES`, `SERVING`, `AGENT`
